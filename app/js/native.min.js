    ...
    */
    ...
    value: function request(url, callback, data) {
      ...
      xhr.onload = function (response) {
        ...
        var codeStatus = codeStatusServer[response.currentTarget.status];
...
var Parse = exports.Parse = function () {
    ...
    _createClass(Parse, null, [{
        key: 'init',
        value: function init() {
            var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document.body;
        ...
        key: 'setStateHistoryComponents',
        value: function setStateHistoryComponents() {
        ...
        value: function parsComponents(componentDom) {
            ...
            componentDom.querySelectorAll('' + Variables.nameForm).forEach(function (component) {
                ...
                component.onsubmit = function () {
                    ...
                    saveForm(this, function (data, form) {
                        var result = true;
                        dataAfterForm = data;
                        ...
                        if (result) {
                            var url = form.getAttribute(Variables.routerHref);
        ...
        value: function getComponentByRoute(url) {
            var _this2 = this;

            if (url.startsWith('/')) {
                Native.request(url, function (component) {
                    _this2._changeComponentDom(component);
                    Router.routing(url);
                });
            }
        }
        ...
        value: function _APIGetRequest(componentDom) {
            ...
            componentDom.querySelectorAll('[' + Variables.routerAPIGET + ']').forEach(function (component) {
                ...
                Native.request(src, function (response) {
                    ...
                    --conuterRequestAPI;
                    _this4._documentIsReady(component);
                });
        ...
        value: function _APIPostRequest(componentDom) {
            ...
            componentDom.querySelectorAll('[' + Variables.routerAPIPOST + ']').forEach(function (component) {
                ...
                Native.request(component.getAttribute(Variables.routerAPIPOST), function (response) {
                    Native.setValueDataByAttr(Native.jsonParse(response));
                    --conuterRequestAPI;
                    _this5._documentIsReady(component);
                }, data);
...
var Virtual = exports.Virtual = function () {
  ...
  */
		...
		value: function parseMethods(methods) {
			...
			try {
				for (var _iterator3 = methods.split(';')[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
					...
					try {
						for (var _iterator4 = event.split(',')[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
							...
							try {
								for (var _iterator5 = connect[0][Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
									...
									try {
										for (var _iterator6 = connect[1][Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
