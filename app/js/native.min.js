  ...
  _createClass(Native, null, [{
    ...
    */
    ...
    value: function request() {
      var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { url: url },
          _ref2$contentType = _ref2.contentType,
          contentType = _ref2$contentType === undefined ? 'multipart/form-data' : _ref2$contentType,
          _ref2$method = _ref2.method,
          method = _ref2$method === undefined ? 'GET' : _ref2$method,
          _ref2$processData = _ref2.processData,
          processData = _ref2$processData === undefined ? true : _ref2$processData,
          _ref2$url = _ref2.url,
          url = _ref2$url === undefined ? null : _ref2$url,
          _ref2$data = _ref2.data,
          data = _ref2$data === undefined ? null : _ref2$data,
          _ref2$beforeSend = _ref2.beforeSend,
          beforeSend = _ref2$beforeSend === undefined ? null : _ref2$beforeSend,
          _ref2$complete = _ref2.complete,
          complete = _ref2$complete === undefined ? null : _ref2$complete,
          _ref2$error = _ref2.error,
          error = _ref2$error === undefined ? null : _ref2$error,
          _ref2$success = _ref2.success,
          success = _ref2$success === undefined ? null : _ref2$success,
...
var Router = exports.Router = function () {
   ...
   */
		...
		key: '_getComponentByRoute',
		value: function _getComponentByRoute(url) {
			var _this2 = this;
...
var Script = exports.Script = function () {
    ...
    _createClass(Script, null, [{
        ...
        value: function hasAttr(component) {
            ...
            component.querySelectorAll(Var.dynamicallyScript).forEach(function (scriptComponent) {
...
var Parse = exports.Parse = function () {
    ...
    _createClass(Parse, null, [{
        ...
        value: function parsComponents(componentDom) {
            ...
            componentDom.querySelectorAll('form').forEach(function (component) {
                var self = _this;
